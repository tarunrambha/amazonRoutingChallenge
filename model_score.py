...
if __name__ == '__main__':
    ...
    output = score.evaluate(
        actual_routes_json = path.join(BASE_DIR,'data/model_score_inputs/new_actual_sequences.json'),
        invalid_scores_json = path.join(BASE_DIR,'data/model_score_inputs/new_invalid_sequence_scores.json'),
        submission_json = path.join(BASE_DIR,'data/model_apply_outputs/proposed_sequences.json'),
        cost_matrices_json = path.join(BASE_DIR,'data/model_apply_inputs/new_travel_times.json')
    ...
    output_path = path.join(BASE_DIR,'data/model_score_outputs/scores.json')
